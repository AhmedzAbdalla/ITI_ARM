...
int main()
{
	...
	//output pins
	GPIO_void_Set_Pin_Mode(GPIOA ,  PIN_15 , OUTPUT);
	GPIO_void_Set_Pin_Type(GPIOA ,  PIN_15  , push_pull);
	GPIO_void_Set_Pin_Speed(GPIOA , PIN_15 , High_speed);
  ...
  while (1)
    {
       // Add your code here.
	  //CLR_BIT(GPIOA_ODR, 1);
	  if(GPIO_u8_Set_Pin_Get_Value(GPIOB ,  PIN_3) == 0)
	  {
		  GPIO_void_Set_Pin_Value_Atomic(GPIOA , PIN_15 , SET);
		  GPIO_void_Set_Pin_Value_Atomic(GPIOB , PIN_15 , SET);
	  }
	  ...
	  {
		  GPIO_void_Set_Pin_Value_Atomic(GPIOA , PIN_15 , RST);
